...
export class JackParser extends antlr.Parser {
  ...
  public subroutineDeclaration(): SubroutineDeclarationContext {
    const localContext = new SubroutineDeclarationContext(
      this.context,
      this.state
    );
  ...
  public subroutineDecWithoutType(): SubroutineDecWithoutTypeContext {
    const localContext = new SubroutineDecWithoutTypeContext(
      this.context,
      this.state
    );
  ...
  public subroutineReturnType(): SubroutineReturnTypeContext {
    const localContext = new SubroutineReturnTypeContext(
      this.context,
      this.state
    );
  ...
  public varNameInDeclaration(): VarNameInDeclarationContext {
    const localContext = new VarNameInDeclarationContext(
      this.context,
      this.state
    );
      ...
      this.enterOuterAlt(localContext, 1);
      {
        ...
        while (
          ...
          if (alternative === 1) {
            ...
            {
              {
                localContext = new ExpressionContext(
                  parentContext,
                  parentState
                );
  ...
  public static readonly _serializedATN: number[] = [
    4, 1, 46, 317, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7, 4,
    ...
    1, 17, 1, 18, 1, 18, 1, 19, 5, 19, 186, 8, 19, 10, 19, 12, 19, 189, 9, 19,
    1, 20, 1, 20, 1, 20, 1, 20, 1, 20, 3, 20, 196, 8, 20, 1, 21, 1, 21, 1, 21,
    3, 21, 201, 8, 21, 1, 21, 1, 21, 1, 21, 1, 21, 1, 22, 1, 22, 1, 23, 1, 23,
    3, 23, 211, 8, 23, 1, 24, 1, 24, 1, 24, 1, 24, 1, 24, 1, 24, 1, 24, 1, 24,
    1, 25, 1, 25, 1, 26, 1, 26, 1, 26, 1, 26, 1, 26, 1, 27, 1, 27, 1, 27, 1, 27,
    1, 27, 1, 27, 1, 27, 1, 27, 1, 28, 1, 28, 1, 29, 1, 29, 1, 29, 1, 29, 1, 30,
    1, 30, 1, 30, 1, 30, 1, 30, 1, 31, 1, 31, 3, 31, 249, 8, 31, 1, 31, 3, 31,
    252, 8, 31, 1, 31, 1, 31, 1, 32, 1, 32, 3, 32, 258, 8, 32, 1, 32, 1, 32, 1,
    33, 1, 33, 1, 33, 5, 33, 265, 8, 33, 10, 33, 12, 33, 268, 9, 33, 3, 33, 270,
    8, 33, 1, 34, 1, 34, 1, 34, 1, 34, 1, 34, 1, 34, 1, 34, 3, 34, 279, 8, 34,
    1, 34, 1, 34, 1, 34, 1, 34, 5, 34, 285, 8, 34, 10, 34, 12, 34, 288, 9, 34,
    1, 35, 1, 35, 1, 35, 1, 35, 1, 35, 3, 35, 295, 8, 35, 1, 36, 1, 36, 1, 37,
    1, 37, 1, 37, 1, 37, 1, 37, 1, 38, 1, 38, 1, 38, 1, 39, 1, 39, 1, 39, 1, 39,
    1, 40, 1, 40, 1, 41, 1, 41, 1, 42, 1, 42, 1, 42, 0, 1, 68, 43, 0, 2, 4, 6,
    ...
    168, 1, 0, 0, 0, 34, 170, 1, 0, 0, 0, 36, 182, 1, 0, 0, 0, 38, 187, 1, 0, 0,
    0, 40, 195, 1, 0, 0, 0, 42, 197, 1, 0, 0, 0, 44, 206, 1, 0, 0, 0, 46, 208,
    1, 0, 0, 0, 48, 212, 1, 0, 0, 0, 50, 220, 1, 0, 0, 0, 52, 222, 1, 0, 0, 0,
    54, 227, 1, 0, 0, 0, 56, 235, 1, 0, 0, 0, 58, 237, 1, 0, 0, 0, 60, 241, 1,
    0, 0, 0, 62, 251, 1, 0, 0, 0, 64, 255, 1, 0, 0, 0, 66, 269, 1, 0, 0, 0, 68,
    278, 1, 0, 0, 0, 70, 294, 1, 0, 0, 0, 72, 296, 1, 0, 0, 0, 74, 298, 1, 0, 0,
    0, 76, 303, 1, 0, 0, 0, 78, 306, 1, 0, 0, 0, 80, 310, 1, 0, 0, 0, 82, 312,
    ...
    0, 0, 164, 162, 1, 0, 0, 0, 165, 166, 3, 38, 19, 0, 166, 167, 3, 32, 16, 0,
    ...
    0, 183, 37, 1, 0, 0, 0, 184, 186, 3, 40, 20, 0, 185, 184, 1, 0, 0, 0, 186,
    189, 1, 0, 0, 0, 187, 185, 1, 0, 0, 0, 187, 188, 1, 0, 0, 0, 188,
 1, 0, 0, 0, 278, 276, 1, 0, 0, 0, 278, 277, 1, 0, 0, 0, 279, 286,
    1, 0, 0, 0, 280, 281, 10, 2, 0, 0, 281, 282, 3, 84, 42, 0, 282, 283, 3, 68,
    34, 3, 283, 285, 1, 0, 0, 0, 284, 280, 1, 0, 0, 0, 285, 288, 1, 0, 0, 0,
    286, 284, 1, 0, 0, 0, 286, 287, 1, 0, 0, 0, 287, 69, 1, 0, 0, 0, 288, 286,
    1, 0, 0, 0, 289, 295, 5, 40, 0, 0, 290, 295, 5, 46, 0, 0, 291, 295, 3, 80,
    40, 0, 292, 295, 5, 43, 0, 0, 293, 295, 5, 44, 0, 0, 294, 289, 1, 0, 0, 0,
    294, 290, 1, 0, 0, 0, 294, 291, 1, 0, 0, 0, 294, 292, 1, 0, 0, 0, 294, 293,
    1, 0, 0, 0, 295, 71, 1, 0, 0, 0, 296, 297, 5, 45, 0, 0, 297, 73, 1, 0, 0, 0,
    298, 299, 3, 72, 36, 0, 299, 300, 5, 22, 0, 0, 300, 301, 3, 68, 34, 0, 301,
    302, 5, 23, 0, 0, 302, 75, 1, 0, 0, 0, 303, 304, 3, 82, 41, 0, 304, 305, 3,
    68, 34, 0, 305, 77, 1, 0, 0, 0, 306, 307, 5, 20, 0, 0, 307, 308, 3, 68, 34,
    0, 308, 309, 5, 21, 0, 0, 309, 79, 1, 0, 0, 0, 310, 311, 7, 3, 0, 0, 311,
    81, 1, 0, 0, 0, 312, 313, 7, 4, 0, 0, 313, 83, 1, 0, 0, 0, 314, 315, 7, 5,
    0, 0, 315, 85, 1, 0, 0, 0, 20, 95, 101, 118, 139, 148, 151, 162, 177, 187,
    195, 200, 210, 248, 251, 257, 266, 269, 278, 286, 294,
  ];

  private static __ATN: antlr.ATN;
  public static get _ATN(): antlr.ATN {
    if (!JackParser.__ATN) {
      JackParser.__ATN = new antlr.ATNDeserializer().deserialize(
  ...
  private static readonly vocabulary = new antlr.Vocabulary(
    JackParser.literalNames,
    JackParser.symbolicNames,
    []
  );
  ...
  private static readonly decisionsToDFA = JackParser._ATN.decisionToState.map(
...
export class ProgramContext extends antlr.ParserRuleContext {
  ...
  public override accept<Result>(
    visitor: JackParserVisitor<Result>
  ): Result | null {
...
export class ClassDeclarationContext extends antlr.ParserRuleContext {
  ...
  public classVarDec(
    i?: number
  ): ClassVarDecContext[] | ClassVarDecContext | null {
    if (i === undefined) {
  ...
  public subroutineDeclaration(
    i?: number
  ): SubroutineDeclarationContext[] | SubroutineDeclarationContext | null {
    if (i === undefined) {
...
export class SubroutineBodyContext extends antlr.ParserRuleContext {
  ...
  public varDeclaration(
    i?: number
  ): VarDeclarationContext[] | VarDeclarationContext | null {
    if (i === undefined) {
...
export class VarDeclarationContext extends antlr.ParserRuleContext {
  ...
  public varNameInDeclaration(
    i?: number
  ): VarNameInDeclarationContext[] | VarNameInDeclarationContext | null {
    if (i === undefined) {
